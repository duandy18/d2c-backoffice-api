...
D2C_BACKOFFICE_DEV_DB_DSN ?= postgresql+psycopg://d2c_backoffice:d2c_backoffice@127.0.0.1:5433/d2c_backoffice
D2C_BACKOFFICE_DEV_TEST_DB_DSN ?= postgresql+psycopg://d2c_backoffice:d2c_backoffice@127.0.0.1:5433/d2c_backoffice_test
...
DEV_ENV := D2C_BACKOFFICE_ENVIRONMENT="$(D2C_BACKOFFICE_ENV)" D2C_BACKOFFICE_DATABASE_URL="$(D2C_BACKOFFICE_DEV_DB_DSN)" D2C_BACKOFFICE_TEST_DATABASE_URL="$(D2C_BACKOFFICE_DEV_TEST_DB_DSN)" PYTHONPATH=.
TEST_ENV := D2C_BACKOFFICE_ENVIRONMENT=test D2C_BACKOFFICE_DATABASE_URL="$(D2C_BACKOFFICE_DEV_TEST_DB_DSN)" D2C_BACKOFFICE_TEST_DATABASE_URL="$(D2C_BACKOFFICE_DEV_TEST_DB_DSN)" PYTHONPATH=.
...
uvicorn-up:
	@if [ -f "$(PID_FILE)" ] && kill -0 "$$(cat $(PID_FILE))" 2>/dev/null; then \
	  ...
	  nohup env PYTHONPATH=. D2C_BACKOFFICE_API_PORT="$(PORT)" D2C_BACKOFFICE_DATABASE_URL="$(D2C_BACKOFFICE_DEV_DB_DSN)" \
